...
valid_country_data_short = {
    ...
    # Guernsey липсва в базата от данни на НАП, пишем го като съседния остров Джърси

    'Остров Джърси (Великобритания)': ['JE', 'JEY', 'Jersey', 'Джърси', 'Остров Джърси', 'GG', 'GGY', 'Guernsey', 'Гърнси', 'Остров Гърнси', 'Гърнси', 'Гърнзи', 'Остров Гърнзи'],
    
    'Панама': ['PA', 'PAN', 'Republic of Panama', 'Panama'],
}
