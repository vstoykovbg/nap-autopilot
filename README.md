...
Бях забравил да направя проверка дали датата е въведена коректно, тя се вкарва в друга функция по технически причини (не е с общата функция fill_input). В новата версия това е коригирано.
