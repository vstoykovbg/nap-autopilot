...
(Една част от автоматизирането на обработката на данните може да го направите с [моите скриптове и електронни таблици за превалутиране](https://github.com/vstoykovbg/BNB_currency_rates).)
